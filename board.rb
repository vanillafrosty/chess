...
class Board
  ...
  def initial_setup
    #note: we're setting up the board such that the rows (each array) represent y-axis
    #coordinates, and columns are x-axis coordinates. so the board pieces
    #start at (0,0) to (7,0), (0,1) to (7,1), (0,7) to (7,7), (0,6) to (7,6)
